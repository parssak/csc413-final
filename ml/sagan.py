...
class Generator(nn.Module):
    ...
    def __init__(self, batch_size, image_size=64, z_dim=100, conv_dim=64):
        ...
        layer3.append(SpectralNorm(nn.ConvTranspose2d(
            curr_dim, int(curr_dim / 2), 4, 2, 1)))
        ...
        if self.imsize == 64:
            layer4 = []
            curr_dim = int(curr_dim / 2)
            layer4.append(SpectralNorm(nn.ConvTranspose2d(
                curr_dim, int(curr_dim / 2), 4, 2, 1)))
...
class Discriminator(nn.Module):
    ...
    def __init__(self, batch_size=64, image_size=64, conv_dim=64):
        ...
        layer1.append(SpectralNorm(nn.Conv1d(4, conv_dim, 1)))
        # in channels = 3, out channels = conv_dim (64)
        ...
        if self.imsize == 64:
            ...
            layer4.append(SpectralNorm(
                nn.Conv1d(curr_dim, curr_dim * 2, 4, 2, 1)))
